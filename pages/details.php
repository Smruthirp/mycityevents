...
";
	...
	<div id="noevent">
		...
		<h3 class="description_heading" style="border-bottom: 1px solid #ccc; padding: 5px; display: block; text-align:center;">Event Description</h3>
		<br />
		<div class="description_para" style="word-break: break-all;">' . $row['description'] . '</div>
		...
		<div style="width: -webkit-fill-available; margin: 20px; padding: 15px">
	...
	<div class="container2">
		<a href="details.php?sel_task=' . $row["ID"] . '" style="text-decoration :none;">
			<img src="data:image/jpeg;base64,' . base64_encode($row['myimage']) . '"/>
			<p  style="color: #333; padding: 10px; border: none; position:relative">' . $row['event'] . ' event in ' . $row['city'] . '</p>
			<p style="font-size:12px">' . $stDate . '</p>
